...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
    ...
    >
      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          ...
          style={{
            width: 'var(--pc-w, 388px)',
          height: 'var(--pc-h, 540px)',
            maxWidth: '100%',
            aspectRatio: '0.718',
            borderRadius: cardRadius,
  ...
  >
    ❌ Avatar gagal dimuat
                ...
                >
                  <div className="items-center gap-3 hidden md:flex">
                    ...
                    <div className="flex flex-col items-start gap-1.5">
                      <div className="text-xs md:text-sm font-medium text-white/90 leading-none">@{handle}</div>
            ...
            >
              <div className="w-full absolute flex flex-col gap-2 top-6" style={{ display: 'flex', gridArea: 'auto' }}>
                <h3
                  className="font-semibold m-0 text-base md:text-4xl"
                  style={{
                ...
                <p
                  className="font-semibold text-xs md:text-lg whitespace-nowrap mx-auto w-min"
                  style={{
                    position: 'relative',
                    top: '-12px',
                    // fontSize: '16px',
