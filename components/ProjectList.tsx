                      ...
                      <div className="mt-5 flex items-center gap-5">
                        {project.repoUrl && (
                          <a
                            ...
                            className="group/link inline-flex items-center gap-2 text-xs text-white/50 transition-colors hover:text-white"
                          >
                            GitHub
                        ...
                        {project.demoUrl && (
                          <a
                            ...
                            className="group/link inline-flex items-center gap-2 text-xs text-[#A855F7] transition-colors hover:text-[#C084FC]"
                          >
                            Live Website
                            <span className="transition-transform group-hover/link:-translate-y-0.5 group-hover/link:translate-x-0.5">
                              ↗
